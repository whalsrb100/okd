...
echo "Please Install \"${MASTER1_HOSTNAME}.${ClusterName}.${DomainName}\" Node"
...
echo "Please Install \"${MASTER2_HOSTNAME}.${ClusterName}.${DomainName}\" Node"
...
echo "Please Install \"${MASTER3_HOSTNAME}.${ClusterName}.${DomainName}\" Node"
